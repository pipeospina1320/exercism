...
export function canFreePrisoner(
  ...
  if(petDogIsPresent){
    ...
    if(canSignalPrisoner(archerIsAwake, prisonerIsAwake) &&           !canExecuteFastAttack(knightIsAwake))  
    {
      return true;
    }

    if(!canExecuteFastAttack(knightIsAwake) && !archerIsAwake && !prisonerIsAwake)
    {
      return true;
    }
    ...
    // if(petDogIsPresent && !canExecuteFastAttack(knightIsAwake)){
    //   return true
    // }
